		...
		<div class="innersidebar recenty_viewed">
			...
			$list_id_product = array();
				...
				if(!empty($_SESSION['viewed_product'])):
					...
					<ul>
						<li class="imageorder"><a href="<?php the_permalink();?>"><?php the_post_thumbnail("small");?></a></li>
						<li class="titlesorder"><a href="<?php the_permalink();?>"><?php echo wp_trim_words(get_the_title(),3);?></a></li>
						<a id="addtocatbutton" data-link="<?php echo get_the_permalink(get_the_ID());?>?add-to-cart=<?php echo get_the_ID();?>" href="javascript:void(0);" onclick="Add_to_Cart(<?php echo get_the_ID();?>);" >Mua ngay</a>
					</ul>
				<?php
