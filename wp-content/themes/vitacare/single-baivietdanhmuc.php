				...
				<div class="box-cat col-xs-12 col-sm-12 col-md-9 col-lg-9">
	               ...
	               <?php
					...
					<?php if(have_posts()) : the_post();  ?>
						<h1 class="entry-title"><?php the_title(); ?></h1>
							<div class="entry-content">
								<ul>
									<li class="tp_thumbnail"><?php the_post_thumbnail();?></li>
									<span class="tp_content"><?php the_content(); ?></span>
								</ul>
							</div>
					...
					<?php do_action( 'genesis_after_loop' ); ?>
						<div id="related-post">
			            	<?php
			                $taxonomy = 'danh-muc-bai-viet-trang-chu';  // or whatever you want
			                $category = wp_get_object_terms( $post->ID, $taxonomy,array('orderby' => 'parent', 'order' => 'DESC'));
			                $args = array(
			                    'post_type' => 'baivietdanhmuc',
			                    'tax_query' => array(
			                        array(
			                            'taxonomy'  => $taxonomy,
			                            'field'     => 'id',
