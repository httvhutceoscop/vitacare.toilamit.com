<?php global $theme; ?>
    ...
    <div <?php post_class('posts clearfix'); ?> id="post-<?php the_ID(); ?>">
        ...
        <div class="entry clearfix">
            ...
            ?>
			<h2 class="titles"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'themater' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
