<?php 
/*
 Template Name: Thanh toan bua an
 */
get_header(); 
global $wpdb;
$email_vitamin = $_POST['myemail'];
$hoten = $_POST['hoten'];
$tuoi = $_POST['tuoi'];
$sex = $_POST['sex'];
$weight = $_POST['weight'];
			...
			<div class="breadcrumbs" typeof="BreadcrumbList" vocab="http://schema.org/">
			    ...
			    <form accept-charset="utf-8" action="" method="post">
				    <div class="content_bill">
				    	<h1 class="page_title">Thông tin thanh toán chuyên đề tư vấn chọn Vitamin</h1>
				    	<div class="form_info col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<ul class="infos">
								...
								<li class="colum_infos col-xs-12 col-sm-6 col-md-6 col-lg-6">Email: <strong><?php echo $email_vitamin;?></strong></strong><input type="hidden" name="email_vitamin" value="<?php echo $email_vitamin;?>"></li>
								...
								<li class="colum_infos"><strong>Lựa chọn các lĩnh vực sức khoẻ cần chăm sóc: </strong>
								<?php
								if(!empty($_POST['checklist'])) {
								 	foreach($_POST['checklist'] as $key=>$check) { ?>
								 		<?php if($check == 1){?>
			    ...
			    <?php
			    	if(isset($_POST['xac_nhan_dinhduong'])){
						...
						$gia_tt = $_POST['gia_tt'];
						$emailvitamin = $_POST['email_vitamin'];
						$bua_sang_t2 = $_POST['bua_sang_t2'];
						$bua_sang_t3 = $_POST['bua_sang_t3'];
						$bua_sang_t4 = $_POST['bua_sang_t4'];
						$bua_sang_t5 = $_POST['bua_sang_t5'];
						...
						$bua_an_nhe_t7 = $_POST['bua_an_nhe_t7'];
						$bua_an_nhe_cn = $_POST['bua_an_nhe_cn'];
			    		$query_dinhduong = $wpdb->query("INSERT INTO xtl_vitamin values('','$ho_ten','$so_tuoi','$gioi_tinh','$can_nang','$chieu_cao','$hoat_dong','$bua_sang_t2','$bua_sang_t3','$bua_sang_t4','$bua_sang_t5','$bua_sang_t6','$bua_sang_t7','$bua_sang_cn','$bua_trua_t2','$bua_trua_t3','$bua_trua_t4','$bua_trua_t5','$bua_trua_t6','$bua_trua_t7','$bua_trua_cn','$bua_toi_t2','$bua_toi_t3','$bua_toi_t4','$bua_toi_t5','$bua_toi_t6','$bua_toi_t7','$bua_toi_cn','$bua_an_nhe_t2','$bua_an_nhe_t3','$bua_an_nhe_t4','$bua_an_nhe_t5','$bua_an_nhe_t6','$bua_an_nhe_t7','$bua_an_nhe_cn','$checklist','$emailvitamin','$gia_tt','$create_date','$modify_date','$status')");
			    		if($query_dinhduong){
							...
							?>
								<script type="text/javascript" language="javascript">
									...
									window.location.replace("<?php echo get_bloginfo('url');?>/thong-bao-so-bill?emailvitamin=<?php echo $emailvitamin;?>");
								</script>
							<?php
