			...
			<div class="breadcrumbs" typeof="BreadcrumbList" vocab="http://schema.org/">
			    ...
			    <form accept-charset="utf-8" action="" method="post">
				    <div class="content_bill">
				    	<h1 class="page_title">Thông tin thanh toán chuyên đề tư vấn bữa ăn hợp lý</h1>
				    	<div class="form_info col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<ul class="infos">
								...
								<li class="colum_infos col-xs-12 col-sm-6 col-md-6 col-lg-6">Email: <strong><?php echo $email_bua_an;?></strong></strong><input type="hidden" name="email_bua_an" value="<?php echo $email_bua_an;?>"></li>
			    ...
			    <?php
			    	if(isset($_POST['xac_nhan_dinhduong'])){
						...
						$gia_tt = $_POST['gia_tt'];
						$email_buaan = $_POST['email_bua_an'];
						$bua_sang_t2 = $_POST['bua_sang_t2'];
						$bua_sang_t3 = $_POST['bua_sang_t3'];
						$bua_sang_t4 = $_POST['bua_sang_t4'];
						$bua_sang_t5 = $_POST['bua_sang_t5'];
						...
						$bua_an_nhe_t7 = $_POST['bua_an_nhe_t7'];
						$bua_an_nhe_cn = $_POST['bua_an_nhe_cn'];
			    		$query_dinhduong = $wpdb->query("INSERT INTO xtl_bua_an values('','$ho_ten','$so_tuoi','$gioi_tinh','$can_nang','$chieu_cao','$hoat_dong','$bua_sang_t2','$bua_sang_t3','$bua_sang_t4','$bua_sang_t5','$bua_sang_t6','$bua_sang_t7','$bua_sang_cn','$bua_trua_t2','$bua_trua_t3','$bua_trua_t4','$bua_trua_t5','$bua_trua_t6','$bua_trua_t7','$bua_trua_cn','$bua_toi_t2','$bua_toi_t3','$bua_toi_t4','$bua_toi_t5','$bua_toi_t6','$bua_toi_t7','$bua_toi_cn','$bua_an_nhe_t2','$bua_an_nhe_t3','$bua_an_nhe_t4','$bua_an_nhe_t5','$bua_an_nhe_t6','$bua_an_nhe_t7','$bua_an_nhe_cn','$email_buaan','$gia_tt','$create_date','$modify_date','$status')");
			    		if($query_dinhduong){
							...
							?>
								<script type="text/javascript" language="javascript">
									...
									window.location.replace("<?php echo get_bloginfo('url');?>/thong-bao-so-bill?emailbuaan=<?php echo $email_bua_an;?>");
								</script>
							<?php
