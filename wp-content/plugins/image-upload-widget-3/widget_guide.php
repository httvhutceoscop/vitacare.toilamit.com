 ...
 */
/*
Plugin Name: Image Upload Widget 3
...
class image_widget_3 extends WP_Widget {
...
public function __construct() {
		parent::__construct(
	 		'image_widget_3', // Base ID
			'Image Upload Widget 3', // Name
 
			array( 'description' => __( 'A widget to upload image 3', 'iuw' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		echo $before_widget; ?>
			...
			<div class="box-right"><h3><?php echo $instance['name'];?></h3>
	...
	<p>
      <label for="<?php echo $this->get_field_id('content'); ?>"><?php _e('Content', 'iuw'); ?></label><br />
      <input type="textarea" name="<?php echo $this->get_field_name('content'); ?>" id="<?php echo $this->get_field_id('content'); ?>" value="<?php echo $content; ?>" class="widefat" />
    </p>
    <p>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "image_widget_3" );' ) );
function iuw_wdScript_3(){
  wp_enqueue_media();
  wp_enqueue_script('adsScript', plugins_url( '/js/image-upload-widget-3.js' , __FILE__ ));
}
add_action('admin_enqueue_scripts', 'iuw_wdScript_3');