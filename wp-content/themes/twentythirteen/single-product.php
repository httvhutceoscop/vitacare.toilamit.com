				...
				<div class="box-conatainer">
					<?php while (have_posts()) : the_post(); ?>
						...
						<div class="product-view col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="product-essential">                            
								<div class="product-img-box col-xs-12 col-sm-12 col-md-5 col-lg-5">
									<div class="thumb_single">
										<?php $url = wp_get_attachment_url( get_post_thumbnail_id($post->ID) );?>
											<a href="<?php echo $url;?>" itemprop="image" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto[product-gallery]"><?php the_post_thumbnail('full');?></a>
									</div>
								...
								<div class="product-shop col-xs-12 col-sm-12 col-md-7 col-lg-7">
										...
										<div>Tình trạng kho: <?php echo get_post_meta(get_the_ID(),'_stock_status',true);?></div>
													...
													if(get_post_meta(get_the_ID(), "_regular_price", true)){ ?>
														...
														if(get_post_meta(get_the_ID(), "_sale_price", true)){ ?>
															<span class="promo_price_single">
																Giá KM: $<?php echo get_post_meta(get_the_ID(), "_sale_price", true);?>
															</span>
															<span class="regular_price_single_">
																Giá: $<?php echo get_post_meta(get_the_ID(), "_regular_price", true);?>
															</span>
															<?php
														}else{?>
						...
						<div class="product-col-left col-xs-12 cl-sm-12 col-md-12 col-lg-12">
									...
									<div id="ingredients" class="content-sp"><?php echo get_post_meta(get_the_ID(),"_thanhphan",true);?></div>
									<div id="faq" class="content-sp"><?php echo get_post_meta(get_the_ID(),"_caccauhoi",true);?></div>
									<div id="reviews" class="content-sp"><?php comments_template(); ?></div>
									<div id="directions" class="content-sp"><?php echo get_post_meta(get_the_ID(),"_huongdansudung",true);?></div>
									<div id="moreinfo" class="content-sp"><?php echo get_post_meta(get_the_ID(),"_thongtinthem",true);?></div>
						</div>
											...
											<h2 class="sec-title">Sản phẩm liên quan</h2>
												...
												?>
														<div class="product-cat item col-xs-6 col-sm-4 col-md-3 col-lg-3">
															...
															<li class="star_rating_box col-xs-12 col-sm-12 col-md-12 col-lg-12">
																<?php
																	echo do_shortcode( '[star_rating themes="flat" id="'.get_the_ID().'"]' ); 
																?>
															</li>
